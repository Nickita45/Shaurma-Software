...
insert into hibernate_sequence values ( 1 );
 insert into hibernate_sequence values ( 1 );
insert into hibernate_sequence values ( 1 );
 create table line (id integer not null AUTO_INCREMENT, description varchar(255), order_id integer not null, user_id integer not null, shaurma bigint not null, primary key (id)) engine=InnoDB;
...
create table shaurma_type (id bigint not null AUTO_INCREMENT, name varchar(255) , price double precision not null, primary key (id)) engine=InnoDB;
create table spice (id bigint not null AUTO_INCREMENT, name varchar(255), price double precision not null, primary key (id)) engine=InnoDB;
